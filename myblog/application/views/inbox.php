...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    ...
    <div id="AdminContent">
<ul class="tabnav"> 
	<li class="tab1 current"><a href="welcome/inbox">所有留言<em>(1)</em></a></li>
	<li class="tab4"><a href="welcome/outbox">已发送留言<em>(0)</em></a></li>
    </ul>
<div class="MsgList">
<ul>
    <?php foreach ($messages as $message){?>
    <li id="msg_186720">
	<span class="sender"><a href="#"><img src="assets/images/12_50.jpg" alt="<?php echo $message->sender?>" title="<?php echo $message->sender?>" class="SmallPortrait" user="12" align="absmiddle"></a></span>
	<span class="msg">
		<div class="outline">
			<a href="#" target="user"><?php echo $message->username?></a>
			发送于 <?php echo $message->post_date?>
