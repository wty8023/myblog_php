...
<!--<form id="frm_reg" action="user/add" method="POST" style="float:left; width:620px;">-->
<form id="frm_reg" action="user/add" onsubmit="return false" method="POST" style="float:left; width:620px;">
...
<script src="assets/images/getcity.js"></script><span class="nodisp">请选择您所在的地区</span></td>
    	...
    	<tr>
    		<th>验证码：</th>		
    		<td><input id="f_vcode" name="code" size="6" class="TEXT" type="text">
