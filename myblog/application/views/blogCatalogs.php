...
<form id="CatalogForm" action="" onsubmit="return false" method="post">
    <h3 id="sub-title">添加博客分类 </h3>
    ...
    <span class="submit">
          ...
          <input id="edit-btn" value="修改&nbsp;»" style="display: none;" tabindex="3" class="BUTTON SUBMIT" type="submit">
          <input id="cancel-btn" value="取消&nbsp;»" style="display: none" tabindex="3" class="BUTTON SUBMIT" type="submit">
        </span>
</form>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.update-btn').on('click',function(){
            ...
            $('#edit-btn').show('fast');
            $('#cancel-btn').show('fast');
            $('#add-btn').hide('fast');
            $('#sub-title').text('修改博客分类');
            var typeId = $(this).parents('tr').find('.name').attr('typeId');
            $('#type-id').val(typeId);
        });
