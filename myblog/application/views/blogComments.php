...
<div class="MainForm BlogCommentManage">
  <h3>共有 <?php echo count($result)?> 篇博客评论，每页显示 20 个，共 1 页</h3>
  <ul>
      <?php foreach ($result as $user_comment){?>
		...
		<span class="comment">
		<div class="user"><b><?php echo $user_comment->username?></b> 评论了 <a href="viewPost_comment.htm" target="_blank"><?php echo $user_comment->title?></a></div>
		<div class="content"><p><?php echo $user_comment->content?></p></div>
		<div class="opts">
